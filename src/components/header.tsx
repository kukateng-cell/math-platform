    ...
    <header className="border-b border-neutral-200 bg-white dark:border-gray-700 dark:bg-gray-900">
      <div className="mx-auto flex h-14 max-w-5xl items-center justify-between gap-2 px-4">
        <Link href="/" className="flex shrink-0 items-center gap-2 font-bold dark:text-white">
          <span className="text-blue-600 dark:text-blue-400"><Icon name="calculator" className="h-6 w-6" /></span>
        ...
        <nav className="flex min-w-0 items-center gap-1 overflow-x-auto text-xs sm:gap-3 sm:text-sm [&::-webkit-scrollbar]:hidden">
          ...
          {user ? (
            ...
            <>
              <Link href="/student/login" className="inline-flex items-center gap-1 whitespace-nowrap rounded-md px-2 py-1 text-neutral-500 hover:bg-neutral-100 hover:text-neutral-700 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200">
                <Icon name="student" className="h-4 w-4" />登入
              </Link>
              <Link
                href="/student/signup"
                className="inline-flex items-center gap-1 whitespace-nowrap rounded-md border border-green-300 bg-green-50 px-2 py-1 font-medium text-green-700 hover:bg-green-100 dark:border-green-800 dark:bg-green-950 dark:text-green-300"
              >
                <Icon name="sprout" className="h-4 w-4" />註冊
              </Link>
            </>
          )}
        </nav>
