    ...
    <main className="mx-auto w-full max-w-4xl flex-1 px-4 py-8">
      ...
      <div className="mb-4 flex flex-wrap items-end gap-3">
        <div className="flex flex-1 flex-col gap-1">
          <label className="text-xs font-medium text-neutral-500">搜尋題目</label>
          <form className="flex gap-2">
            ...
            {query && (
              <a
                ...
                className="rounded-lg px-3 py-2 text-sm text-neutral-400 hover:text-neutral-700"
              >
                ✕ 清除
              </a>
            )}
      ...
      <div className="mb-3 flex items-center justify-between">
        <h2 className="font-semibold">
          現有題目（{total}）
          {(query || filterSkillId) && (
            <span className="ml-1 text-sm font-normal text-neutral-400">— 已篩選</span>
          )}
        </h2>
        {totalPages > 1 && (
